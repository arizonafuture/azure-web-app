...
const ExpertCardSlider: React.FC<ExpertCardProps> = ({ expert }) => {
  ...
  return (
    <div
      key={expert.id}
      className="
  bg-transparent rounded-[20px] rounded-b-[30px] pb-0 flex flex-col
  overflow-hidden flex-shrink-0 w-[85%] snap-start
  md:overflow-visible md:flex-shrink md:w-auto md:snap-none
"
    >
      {/* Profile Image */}
