  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 items-start justify-start self-stretch">
          ...
          {session.date && (
            <div className="flex flex-row gap-4 items-start justify-start self-stretch shrink-0 relative flex-wrap">
              <div className="flex flex-row gap-1 items-center">
                ...
                <span className="text-white body-text-small">
        ...
        <div className="bg-white self-stretch h-px opacity-[0.3]"></div>

        <div className="flex flex-col gap-2 items-start justify-start self-stretch">
          <div className="text-white text-sm self-stretch !leading-[1.5] mb-5">
